  ...
  <div class="section-item section-item-no-padding">
    <div class="menu-item">
      ...
      <div class="inline-item" v-for="(item,index) in currentSearch.searchMenu.private">
        ...
        <el-button  v-else-if="item.type == 'new-export'" @click="toExportList()" v-bind:type="item.style" >{{item.label}}</el-button>
...
//  import Util from '../../assets/js/common/utils'
  ...
  export default {
    ...
    methods: {
      ...mapActions(['setCurrentSearchQuery','setClearSelect','exportProductList','exportBaseProduct']),
      reset() {
