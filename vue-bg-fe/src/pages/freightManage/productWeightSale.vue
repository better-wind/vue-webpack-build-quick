  ...
  <div>
    ...
    <div class="section">
      ...
      <div class="section-item pd-r" style="text-align: right">
        ...
        <!--<el-button size="small" @click="resh" type="primary">刷新</el-button>-->
      </div>
    </div>
  </div>
</template>
...
//        },
    ...
    methods:{
      ...mapActions(['getSkuWeightList','saveSkuWeight','callSetNotice','getUnSetSkuWeightAmount']),
      initView(){
        this.getUnSetSkuWeightAmount()
          .then((rs)=>{
...
//        console.log(grossWeightList)
        this.saveSkuWeight({grossWeightList:grossWeightList})
          .then(()=>{
              this.getNotice('提交成功')
              this.initScroll()
              this.scrollPage()
